...
# Plot the contours
img1 = ax.contourf(lons, lats, ws, cmap=cmap, levels=levels, extend='both', transform=ccrs.PlateCarree())    
img2 = ax.contour(lons, lats, ws, colors='white', linewidths=0.3, levels=levels, transform=ccrs.PlateCarree())
...
img3 = ax.streamplot(lons, lats, ucomp, vcomp, density=[4, 4], linewidth=1, color='gray', transform=ccrs.PlateCarree())
...
# Add a colorbar
plt.colorbar(img1, label='Isotachs (kt)', orientation='horizontal', pad=0.05, fraction=0.05)
