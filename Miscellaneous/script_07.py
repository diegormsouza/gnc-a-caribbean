...
# Converting the extents (min / max lats and min / max lons) 
#from epsg:4326 (equidistant) to epsg:3857 (mercator)

import pyproj # Python interface to PROJ (cartographic projections and coordinate transformations library)

# Transform the extent from epsg:4326 (equidistant) to epsg:3857 (mercator)
# So we can pass the mercator extent to Cartopy later
